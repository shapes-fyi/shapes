...
- `shapes-maintain` activates when editing code, creating files, preparing
  ...
  the graph in sync
- `shapes-init` activates when bootstrapping shapes for a new project

## Shapes-First Principle

No code changes without shapes changes first. The graph is the plan; code is the execution.
