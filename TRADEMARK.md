...
You **may not** use our marks in the following ways without explicit
written permission from shapes-fyi:

- **Product or service names** — naming your product, service, or company
  using any of our marks (e.g., "Shapes Cloud", "OpenContext Platform")
- **Domain names** — registering domain names that contain our marks
- **Implying endorsement** — suggesting that shapes-fyi sponsors, endorses,
  or is affiliated with your product or organization
...
shapes-fyi reserves all rights to enforce these trademarks. Unauthorized
use of our marks, including use that is likely to cause confusion, dilute
the marks, or imply false endorsement, may result in legal action.

If you become aware of any use of our marks that violates this policy,
please report it to the contact below.

## Requesting Permission

For uses not covered by this policy, or to request written permission
for a prohibited use, contact shapes-fyi through:

- GitHub: https://github.com/shapes-fyi/shapes/issues
- Email: See the repository maintainers

## Changes to This Policy

shapes-fyi reserves the right to update this policy at any time. Changes
will be reflected in the official repository.
